...
class Kivy4(MDApp):
    ...
    def setFile(self, file, value, extension='.txt', is_json=False):
        ...
        if json:
            value_to_save = json.dumps(value_to_save)
    ...
    def getFile(self, file, default=None, create_file_if_not_exist=False, extension='.txt', is_json=False):
